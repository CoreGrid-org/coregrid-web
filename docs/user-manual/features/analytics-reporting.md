...
Generate an asset inventory report, a maintenance report, a disposal report or an audit campaign report,
each filterable by date, department, category, status and condition — and export any of them as PDF or CSV,
reflecting whatever filters are applied on screen.
